...
const Login = () => {
  ...
  // Detect session expiration from auto-logout
  useEffect(() => {
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '420px', padding: '1rem' }}>
        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          ...
          {expired && (
            <div style={{ background: 'rgba(255,107,107,0.1)', border: '1px solid rgba(255,107,107,0.3)', borderRadius: 12, padding: '12px 16px', marginBottom: '1.5rem', display: 'flex', gap: 10, alignItems: 'center' }}>
              <span style={{ fontSize: 18 }}>⏱️</span>
              <p style={{ margin: 0, fontSize: '0.8rem', color: '#ff6b6b', lineHeight: 1.5 }}>
